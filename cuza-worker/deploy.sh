...
if wrangler deploy; then
    ...
    echo "   📄 File listing: https://cuza-worker.dynow.workers.dev/api/files"
    echo "   📁 File serving: https://cuza-worker.dynow.workers.dev/api/files/{path}"
    echo "   📤 File upload:  https://cuza-worker.dynow.workers.dev/upload"
    echo ""
